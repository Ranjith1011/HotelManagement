...
if($_SERVER['REQUEST_METHOD']=="POST")
{
		...
		if(!empty($_POST['checkrooms']))
	{
		...
		$_SESSION["i"]=$i;
		header("Location:bookroom31.php");
	}
	else
	{
...
$sql="SELECT Room_No
	  ...
	  WHERE (Check_In<'$check_out' AND Check_Out>'$check_out')OR(Check_In<'$check_in' AND Check_Out>'$check_in'))";
...
?>
<br>
<a href="bookroom1.php"><p4>Modify Search</p4></a>
