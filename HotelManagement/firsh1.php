...
<html>
<head>
<title>Hotel Manam first page</title>
<style type="text/css">
h1
{
	color:White;
...
?>
<h1 id="font">Premam Group of Hotels<br>Welcomes You and Your Family...</h1>
...
<a href="loginuser.php"> <p1>User Login</p1></a>
<a href="register.php"><p1 style="padding-left:70px" >Register</p1></a>
<a href="loginemployee.php"><p1 style="padding-left:70px" >Employee Login</p1></a>
<a href="ratings.php"><p1 style="padding-left:70px" >Ratings & Reviews</p1></a>
</body>
</html>